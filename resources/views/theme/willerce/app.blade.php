...
<head>
    ...
    <link rel='stylesheet' id='qzhai-css' href='{{ asset('theme/willerce/css/style.css?ver=4.5.1') }}' type='text/css' media='all'/>
    <script type='text/javascript' src='{{ asset('theme/willerce/js/jquery.min.js?ver=4.5.1') }}'></script>
...
<div id="main" class="wp uk-grid uk-grid-collapse" style="max-width:1120px">
    ...
    @include('theme.willerce.layouts.footer')
</body>
</html>