      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              <a href="#">
                <i class="fa fa-edit"></i> <span>笔记管理</span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li><a href="{{ url('admin/note/create') }}"><i class="fa fa-circle-o"></i>新建笔记</a></li>
                <li><a href="{{ url('admin/note') }}"><i class="fa fa-circle-o"></i>笔记列表</a></li>
                <li><a href="{{ url('admin/note/recycle') }}"><i class="fa fa-circle-o"></i> 回收站</a></li>
              </ul>
            </li>
