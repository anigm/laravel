...
<!-- Default box -->
  <div class="box">
    <div class="box-body">
      <button id="create-new-backup-button" href="<?php echo e(url('admin/backup/create')); ?>" class="btn btn-primary ladda-button" data-style="zoom-in"><span class="ladda-label"><i class="fa fa-plus"></i> <?php echo e(trans('backpack::backup.create_a_new_backup')); ?></span></button>
      <br>
      ...
      <table class="table table-hover table-condensed">
        <thead>
          <tr>
            ...
            <th><?php echo e(trans('backpack::backup.actions')); ?></th>
          </tr>
        </thead>
        <tbody>
          <?php foreach($backups as $k => $b): ?>
          <tr>
            ...
            <td>
                <a class="btn btn-xs btn-default" href="<?php echo e(url('admin/backup/download/'.$b['file_name'])); ?>"><i class="fa fa-cloud-download"></i> <?php echo e(trans('backpack::backup.download')); ?></a>
                <a class="btn btn-xs btn-danger" data-button-type="delete" href="<?php echo e(url('admin/backup/delete/'.$b['file_name'])); ?>"><i class="fa fa-trash-o"></i> <?php echo e(trans('backpack::backup.delete')); ?></a>
            </td>
          </tr>
          <?php endforeach; ?>
        </tbody>
