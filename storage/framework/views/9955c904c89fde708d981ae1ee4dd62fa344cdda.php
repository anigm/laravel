<?php $__env->startSection('content'); ?>
    ...
    <div class="panel panel-default">
        <div class="panel-body content-form">
            <div class="col-lg-12">
                ...
                <form method="post" action="<?php echo e(route('admin.public.postuploadpic')); ?>" accept-charset="utf-8" enctype="multipart/form-data" id="uploadpic">
    ...
    <script src="<?php echo e(asset('plugin/form/jquery.form.js')); ?>"></script>
    <?php echo $__env->make('admin.vendor.endChosen', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <script type="text/javascript">
        ...
        <?php echo $__env->make('admin.vendor.endBuildHtml', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        // ajax form拦截提交事件
        $('#uploadPicSubmit').click(function ()
        {
            var options = {
                ...
                success: function (data)
                {
                    ...
                    {
                        var from = 'thumb';
                        <?php /*var from = '<?php echo e(Input::get('from','thumb')); ?>';*/ ?>
...
<?php echo $__env->make('layouts.admin-app-upload', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>